...
const ctx_1 = __webpack_require__(36);
const downloader_1 = __webpack_require__(44);
const inlay_hints_1 = __webpack_require__(70);
...
function debugSingle() {
    return async (runnable) => {
        ...
        const proc = child_process_1.spawn(runnable.kind, args, { shell: true });
        ...
        await coc_nvim_1.workspace.nvim.command(`TermdebugCommand ${executable} ${executableArgs}`);
    };
}
...
function openDocs(ctx) {
    return async () => {
        ...
        if (doclink) {
            await coc_nvim_1.commands.executeCommand('vscode.open', coc_nvim_1.Uri.parse(doclink));
        }
    };
}
...
const callHierarchy = __webpack_require__(34);
const st = __webpack_require__(35);
var Proposed;
(function (Proposed) {
...
const protocol_implementation_1 = __webpack_require__(25);
exports.ImplementationRequest = protocol_implementation_1.ImplementationRequest;
const protocol_typeDefinition_1 = __webpack_require__(26);
exports.TypeDefinitionRequest = protocol_typeDefinition_1.TypeDefinitionRequest;
const protocol_workspaceFolders_1 = __webpack_require__(27);
exports.WorkspaceFoldersRequest = protocol_workspaceFolders_1.WorkspaceFoldersRequest;
exports.DidChangeWorkspaceFoldersNotification = protocol_workspaceFolders_1.DidChangeWorkspaceFoldersNotification;
const protocol_configuration_1 = __webpack_require__(28);
exports.ConfigurationRequest = protocol_configuration_1.ConfigurationRequest;
const protocol_colorProvider_1 = __webpack_require__(29);
exports.DocumentColorRequest = protocol_colorProvider_1.DocumentColorRequest;
exports.ColorPresentationRequest = protocol_colorProvider_1.ColorPresentationRequest;
const protocol_foldingRange_1 = __webpack_require__(30);
exports.FoldingRangeRequest = protocol_foldingRange_1.FoldingRangeRequest;
const protocol_declaration_1 = __webpack_require__(31);
exports.DeclarationRequest = protocol_declaration_1.DeclarationRequest;
const protocol_selectionRange_1 = __webpack_require__(32);
exports.SelectionRangeRequest = protocol_selectionRange_1.SelectionRangeRequest;
const protocol_progress_1 = __webpack_require__(33);
...
const coc_nvim_1 = __webpack_require__(1);
const executable_1 = __importDefault(__webpack_require__(37));
const fs_1 = __webpack_require__(2);
const os_1 = __webpack_require__(17);
const path_1 = __webpack_require__(16);
const vscode_languageserver_protocol_1 = __webpack_require__(6);
const which_1 = __importDefault(__webpack_require__(39));
...
const isexe = __webpack_require__(40)
...
const crypto_1 = __webpack_require__(18);
const fs_1 = __webpack_require__(2);
const https_proxy_agent_1 = __webpack_require__(45);
const node_fetch_1 = __importDefault(__webpack_require__(63));
const os_1 = __importDefault(__webpack_require__(17));
const path_1 = __importDefault(__webpack_require__(16));
const stream_1 = __importDefault(__webpack_require__(64));
const util_1 = __importDefault(__webpack_require__(56));
...
const agent_1 = __importDefault(__webpack_require__(46));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const net_1 = __importDefault(__webpack_require__(19));
const tls_1 = __importDefault(__webpack_require__(47));
const url_1 = __importDefault(__webpack_require__(48));
const assert_1 = __importDefault(__webpack_require__(49));
const debug_1 = __importDefault(__webpack_require__(50));
const agent_base_1 = __webpack_require__(59);
const parse_proxy_response_1 = __importDefault(__webpack_require__(62));
...
const util = __webpack_require__(56);
...
const events_1 = __webpack_require__(60);
const debug_1 = __importDefault(__webpack_require__(50));
const promisify_1 = __importDefault(__webpack_require__(61));
...
/* harmony export */ });
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(64);
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(48);
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(66);
/* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(67);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.openDocs = exports.ssr = exports.inlayHints = exports.runnables = exports.onEnter = exports.joinLines = exports.resolveCodeAction = exports.parentModule = exports.matchingBrace = exports.expandMacro = exports.syntaxTree = exports.reloadWorkspace = exports.status = exports.memoryUsage = exports.analyzerStatus = void 0;
const lc = __importStar(__webpack_require__(6));
...
exports.openDocs = new lc.RequestType('experimental/externalDocs');
...
class Config {
    constructor() {
        ...
        this.requiresReloadOpts = ['serverPath', 'cargo', 'procMacro', 'files', 'updates', 'lens', 'hoverActions'].map((opt) => `${this.rootSection}.${opt}`);
        coc_nvim_1.workspace.onDidChangeConfiguration((event) => this.onConfigChange(event));
        this.cfg = coc_nvim_1.workspace.getConfiguration(this.rootSection);
    }
...
class HintsUpdater {
    constructor(ctx) {
        ...
        coc_nvim_1.workspace.documents.forEach((doc) => {
            if (doc && ctx_1.isRustDocument(doc.textDocument)) {
